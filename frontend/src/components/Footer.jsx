...
const Footer = () => {
  return (
    <footer className="w-full bg-transparent text-[#888] pt-16 pb-8 border-t border-white/10">
      <div className="container mx-auto px-4 md:px-6 border-b border-white/10 pb-8 mb-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-[#ededed] font-semibold mb-6 text-sm">
              Tautan Lain
            </h4>
