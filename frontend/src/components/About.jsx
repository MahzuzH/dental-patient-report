      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-[#0a0a0a] rounded-2xl p-8 border border-white/5 hover:border-white/10 transition-colors duration-300 group flex flex-col items-start"
            >
              <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:bg-[#ff91a4]/10 group-hover:border-[#ff91a4]/20">
                {feature.icon}
              </div>
        ...
        {/* Content Section */}
        <div className="mt-24 bg-[#050505] rounded-[2rem] p-8 md:p-12 border border-white/10 overflow-hidden relative shadow-2xl flex flex-col md:flex-row items-center gap-12">
          {/* Ambient Glows */}
          ...
          <div className="w-full md:w-1/2 relative z-10">
            <h3 className="text-2xl md:text-4xl font-bold mb-6 text-white tracking-tight">
              Berkomitmen pada <br />
              <span className="text-[#888]">Keunggulan Perawatan</span>
            </h3>
            <p className="text-[#888] mb-8 leading-relaxed text-lg">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center gap-4 text-[#ededed] font-medium"
                >
          ...
          <div className="w-full md:w-1/2 rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] relative border border-white/10 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex items-end p-8 z-20">
              <p className="text-white font-medium text-sm md:text-base border-l-2 border-[#ff91a4] pl-4">
