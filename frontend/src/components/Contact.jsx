      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight">
            Lokasi & <span className="text-[#888]">Kontak</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 bg-[#050505] p-8 md:p-10 rounded-[2rem] border border-white/10 relative overflow-hidden flex flex-col group">
            {/* Ambient Glow */}
            <div className="absolute top-[-20%] right-[-20%] w-64 h-64 bg-[#ff91a4]/5 rounded-full blur-[80px] pointer-events-none transition-opacity duration-500 group-hover:opacity-100 opacity-50"></div>

            <h3 className="text-2xl font-bold mb-8 text-[#ededed] tracking-tight relative z-10">
              Informasi Kontak
            </h3>
            ...
            <div className="space-y-8 relative z-10 flex-1">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-[#ededed] mb-1">
                    Alamat Klinik
                  </h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#888] text-sm">+62 889-7526-2351</p>
                </div>
              </div>
            ...
            <div className="mt-10 relative z-10">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-[#ededed] hover:bg-white text-black font-semibold py-4 px-6 rounded-xl transition-colors duration-200"
              >
          ...
          <div className="lg:col-span-3 min-h-[400px] bg-[#050505] border border-white/10 relative rounded-[2rem] overflow-hidden p-2 flex">
