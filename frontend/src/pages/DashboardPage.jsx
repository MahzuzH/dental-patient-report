      ...
      <div className="h-full w-full">
        ...
        <main className="h-full space-y-3 overflow-hidden p-3 sm:p-4 lg:pl-[17rem]">
          ...
          <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <Card className="border-violet-100 bg-white">
              <CardContent className="p-3">
                <p className="text-sm text-slate-500">Pemeriksaan Hari Ini</p>
                <h2 className="mt-2 text-3xl font-bold">{stats.today}</h2>
              </CardContent>
            </Card>
            <Card className="border-violet-100 bg-white">
              <CardContent className="p-3">
                <p className="text-sm text-slate-500">Total Pemeriksaan</p>
          ...
          <section className="grid gap-3 xl:grid-cols-3">
                      ...
                      <tbody>
                        {recentExams.map((exam) => (
                          ...
                          >
                            ...
                            <td className="py-2">{exam.institution}</td>
                            <td className="py-2">
                              {formatDate(exam.scanDate)}
                            </td>
                            <td className="py-2">
                              <span
                            ...
                            <td className="py-2">
                              <div className="flex items-center justify-center gap-2">
                                <Button
                                  ...
                                  variant="outline"
                                  onClick={() =>
                                    handleViewReport(exam.token || exam.id)
                                  }
                                >
                                  View
                                </Button>
            ...
            <Card className="border-violet-100 bg-white">
              <CardContent className="p-3">
                <h3 className="mb-2 text-base font-semibold">Top Instansi</h3>
                <div className="h-40">
                  <ResponsiveContainer width="100%" height="100%">
      ...
      <Dialog open={isQRModalOpen} onOpenChange={setIsQRModalOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Scan QR ini untuk melihat laporan kesehatan gigi pasien.
            </DialogDescription>
          </DialogHeader>
